...
void SerializeComponent(KeyConfig c, std::string& str_rep)
{
	str_rep += "KeyConfig{";
...
void DeserializeComponent(KeyConfig& c, std::string str_rep)
{
