...
void Game::GoToMainMenu()
{
	...
	{
		auto [entity_id, shader, draw_info, draw_priority, width_and_height, position] = active_level_.CreateEntitiyWith<Shader, DrawInfo, DrawPriority, WidthAndHeight, Position>();
