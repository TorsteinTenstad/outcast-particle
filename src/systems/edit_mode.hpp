...
private:
	...
	const std::vector<std::string> blueprint_menu_entry_tags_ { "BPStaticParticle", "BPPlayer", "BPLaser", "BPWall", "BPGoal", "BPElectricField", "BPMagneticField", "BPCoin", "BPBlackHole", "BPTextPopupSpawner" };
