...
CREATE_PURE_DO_SYSTEM_DECLARATION(AddKillOnIntersectionSystem)
...
CREATE_PURE_DO_SYSTEM_DECLARATION(CanDisableButtonSystem);
CREATE_PURE_DO_SYSTEM_DECLARATION(CoinSystem);
...
CREATE_PURE_DO_SYSTEM_DECLARATION(ExitGameSystem);
...
CREATE_PURE_DO_SYSTEM_DECLARATION(OpenFileDialogSystem);
CREATE_PURE_DO_SYSTEM_DECLARATION(PlayerSystem);
CREATE_PURE_DO_SYSTEM_DECLARATION(ScaleWithLevelSystem);
...
CREATE_PURE_DO_SYSTEM_DECLARATION(ShowErrorSystem);
CREATE_PURE_DO_SYSTEM_DECLARATION(SetDrawInfoSystem);
CREATE_PURE_DO_SYSTEM_DECLARATION(SetWallSoundSystem);
...
CREATE_PURE_DO_SYSTEM_DECLARATION(TogglingLaserSystem);
CREATE_PURE_DO_SYSTEM_DECLARATION(TooltipSystem);
CREATE_PURE_DO_SYSTEM_DECLARATION(TrailerIntroHelperSystem);
CREATE_PURE_DO_SYSTEM_DECLARATION(TrailSystem);
CREATE_PURE_DO_SYSTEM_DECLARATION(VelocitySystem);
CREATE_PURE_DO_SYSTEM_DECLARATION(WormholeSystem);
